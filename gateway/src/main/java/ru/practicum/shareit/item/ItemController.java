...
public class ItemController {
    ...
    @GetMapping("/search")
    public ResponseEntity<Object> searchItems(@RequestParam @Valid String text,
                                     @RequestParam(defaultValue = "0") @PositiveOrZero int from,
                                     @RequestParam(defaultValue = "10") @Positive int size) {
    ...
    public ResponseEntity<Object> addComment(@PathVariable long itemId, @RequestBody CommentDtoRequest commentDtoRequest,
                                 @RequestHeader(name = Constant.HEADER) Long ownerId) {
